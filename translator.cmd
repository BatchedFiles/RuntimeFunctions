...
rem dll lib console gui service native driver
...
"%CompilerDirectory%\fbc.exe" %DYNAMIC_LIBRARY_DEFINED% %WITHOUT_RUNTIME_DEFINED% %AllCompiledFiles% %AllResourceFiles% -x %OutputFileName% %WriteOutOnlyAsm% -s %Win32Subsystem% %ExeTypeKind% -gen %CodeGenerationBackend% %CompilerParameters% >%CompilerLogErrorFileName%
